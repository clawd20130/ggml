...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_style_bert_vits2_conv_transpose_1d_phase_simdgroup(ggml_metal_library_t lib, const struct ggml_tensor * op, const char * kernel_name);
